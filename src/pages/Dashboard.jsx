...
const Dashboard = () => {
  ...
  const fetchDashboardData = async () => {
    ...
    try {
      ...
      const userRes = await fetch(
        `http://localhost:8085/api/users/email/${userId}`,
        {
          headers: {
      ...
      const walletRes = await fetch(`http://localhost:8085/wallet/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
        },
      ...
      const transactionsRes = await fetch(
        `http://localhost:8085/api/transactions/user/${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
      ...
      // Fetch notifications from correct port (8085)
      let userNotifications = [];
      try {
        const notificationsRes = await fetch(
          `http://localhost:8085/api/notify/${id}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
              "Content-Type": "application/json",
      ...
      try {
        const rewardsRes = await fetch(
          `http://localhost:8085/api/rewards/${id}`,
          {
            headers: {
              Authorization: `Bearer ${token}`,
              "Content-Type": "application/json",
  ...
  const checkNewNotifications = async () => {
    try {
      ...
      const response = await fetch(`http://localhost:8085/api/notify/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`,
          "Content-Type": "application/json",
        },
          ...
          <a href="/transactions" className="nav-item">
            ...
            >
              <path
                ...
                strokeLinejoin="round"
                strokeWidth={2}
                d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v1m0 6v1m0-1v1m6-10a2 2 0 11-4 0 2 2 0 014 0zM6 18a2 2 0 11-4 0 2 2 0 014 0z"
              />
            </svg>
